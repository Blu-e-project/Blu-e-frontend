...
import com.example.blu_e.login.FindIdActivity
...
class RecruitMentorActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        viewBinding.backToCenter.setOnClickListener {
            val intent = Intent(this@RecruitMentorActivity, MainActivity:: class.java)
                                ...
                                val builder = AlertDialog.Builder(this@RecruitMentorActivity)
                                    ...
                                    .setPositiveButton("확인",
                                        DialogInterface.OnClickListener{ dialog, which ->
                                            Toast.makeText(this@RecruitMentorActivity, "확인", Toast.LENGTH_SHORT).show()
                                            val intent = Intent(this@RecruitMentorActivity, MainActivity:: class.java)
                                            startActivity(intent)
                                        })
                                builder.show()
